...
from models.blocks import build_softargmax_1d
from models.blocks import build_softargmax_2d
from models.blocks import build_joints_probability
...
def _sepconv_residual(x, out_size, name, kernel_size=(3, 3)):
    ...
    if num_filters == out_size:
        ...
        if out_size > num_filters:
            ...
            ident = act_conv_bn(x, out_size, (1, 1), name=reduce_name)
